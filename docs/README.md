# MGraph AI Service AWS Comprehend Documentation

## Overview

MGraph AI Service AWS Comprehend will be a production-ready FastAPI microservice that provides Large Language Model (BASE) capabilities through a secure, type-safe API. 
...
```yaml
Runtime: python3.12
Handler: mgraph_ai_service_aws__comprehend.fast_api.lambda_handler.run
MemorySize: 512
Timeout: 30
Environment:
  Variables:
