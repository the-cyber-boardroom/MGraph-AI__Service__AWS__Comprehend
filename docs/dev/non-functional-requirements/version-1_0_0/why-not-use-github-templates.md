...
git remote add template https://github.com/org/MGraph-AI__Service__AWS__Comprehend.git
```
...
git fetch template
git checkout template/main -- mgraph_ai_service_aws__comprehend/routes/health.py
