# MGraph AI Service AWS Comprehend

[![Current Release](https://img.shields.io/badge/release-v0.5.0-blue)](https://github.com/the-cyber-boardroom/MGraph-AI__Service__AWS__Comprehend/releases)
...
[![CI Pipeline - DEV](https://github.com/the-cyber-boardroom/MGraph-AI__Service__AWS__Comprehend/actions/workflows/ci-pipeline__dev.yml/badge.svg)](https://github.com/the-cyber-boardroom/MGraph-AI__Service__AWS__Comprehend/actions)
...
To create a new service from this template, see [Creating Services from MGraph-AI__Service__AWS__Comprehend](docs/dev/non-functional-requirements/version-1_0_0/README.md).
...
# or
uvicorn mgraph_ai_service_aws__comprehend.fast_api.lambda_handler:app --reload --host 0.0.0.0 --port 10011
```
...
```
mgraph_ai_service_aws__comprehend/
├── fast_api/
...
# Run with coverage
pytest --cov=mgraph_ai_service_aws__comprehend
...
- 🐛 Issues: [GitHub Issues](https://github.com/the-cyber-boardroom/MGraph-AI__Service__AWS__Comprehend/issues)
- 💬 Discussions: [GitHub Discussions](https://github.com/the-cyber-boardroom/MGraph-AI__Service__AWS__Comprehend/discussions)
